...
#   BUY LIMIT = signal candle close - 50
#
# SELL:
#   SuperTrend Bullish -> Bearish
#   SELL LIMIT = signal candle close + 50
#
# TP:
#   BUY  : Entry +300 / +600 / +900
#   SELL : Entry -300 / -600 / -900
#
# Reversal before entry fill:
...
# Delta BTCUSD:
# 1 contract = approximately 0.001 BTC
#
# 3 contracts = approximately 0.003 BTC
...
def load_product():
    ...
    if not result:
        ...
        raise RuntimeError(
            "Product information not returned."
        )
...
def place_limit_order(
    ...
    print("Client ID  :", client_order_id)
    print("=================================")
